...
Object.keys(testAPIs).forEach((IPFS) => {
  describe('Log - Join (' + IPFS + ')', function () {
    ...
    before(async () => {
      ...
      testIdentity = await IdentityProvider.createIdentity({ id: 'userC', identityKeystore, signingKeystore })
      testIdentity2 = await IdentityProvider.createIdentity({ id: 'userB', identityKeystore, signingKeystore })
      testIdentity3 = await IdentityProvider.createIdentity({ id: 'userD', identityKeystore, signingKeystore })
      testIdentity4 = await IdentityProvider.createIdentity({ id: 'userA', identityKeystore, signingKeystore })
